...
- Community announcements (if any)
   ...
   - There will be a Islandora Camp in Vancounver
...
- Discuss the issues with the how our docs are built.
   ...
   - Related ticket: https://github.com/Islandora/documentation/pull/2397
    ...
    - Let us think about a deadline to approve the switch to Zensical
        - perhaps use the meeting time to have folks try out the preview
    - https://zensical.org/docs/setup/basics/?h=mkdocs#transition-from-mkdocs
      - "Support for configuration with mkdocs.yml will always be supported, but eventually move out of the core."
      - Joe had a good idea to stick to mkdoc.yml for a while, in case there is a n issue witht his platform. 
...
- ACTION ITEM: Create a docs PR to link to scyllaridae docs site from main  docs 
