...
## Attendance
* Yamil Suarez, Annie Oelschlagger, Kestrel Ward, Aubrey Shanahan
...
- Community announcements (if any)
    - IslandoraCon: Community HackDoc/ Hackathon
        ...
        - Aubrey is sending a survey on behalf of the Roadmap group, about priorities for community
        - DLF in Denver next month – doing a meet and greet 1-2 on Tuesday, Community update, happy hour and dine around afterwards
...
- Islandora Foundation - Leadership Group proposal (LG) for DIG
    ...
    - Made some suggested changes in document, 
