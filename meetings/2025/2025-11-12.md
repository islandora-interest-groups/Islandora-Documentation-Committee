# Documentation Interest Group — November 12th, 2025 — 2:00 PM Eastern

Zoom: https://us02web.zoom.us/j/86061293910?pwd=6yhfHWDAxQawyJ4PwE21nTj7ND9n5j.1

## Attendance
* Yamil, Annie, Kestrel, Josh, Carolyn, Aubrey
...
- Community announcements (if any)
  - 2 new repositories accepted and uploaded to islandora.org – one is a replacement for Crayfish
    -https://github.com/Islandora/mirador-integration-islandora
    -https://github.com/Islandora/scyllaridae/tree/main
      -Scyllaridae uses Go, may be worth learning some Go
- Doc related PRs to talk about
  - Did not get to except to confirm Josh had no questions
  - https://github.com/Islandora/documentation/pull/2375
    ...
    - Need to decide how we combine the content here (https://islandora.github.io/documentation/user-documentation/extending/#recipes) with the above PR
        - Note: The "extending Islandora" page contains these sections
         ...
         -needs to be moved to main documentation, want to give credit – Annie and Yamil will meet to approve
  - https://github.com/Islandora-Labs/Islandora-Cookbook/pull/19
    - Create remote-media.md #19
    - needs to be looked at for movement to main documentation – Yamil is going to look at it, need to ask if they want to move it so they get credit
...
- Islandora Foundation - Leadership Group proposal (LG) for DIG
    ...
    - Took time to read over draft and comment
    - Changing Github repository name to Committee from Interest Group – Yamil was able to do this
    - Made draft only editable by added editor, not link
    - Made some suggested changes in document, Worked on editing second half of document
    - Revisit bullet point in scope: Provide stable documentation endpoints/’hooks’ for integration with the Islandora UI and coordinate improved implementation of documentation directly in the UI
      - Decided to keep for now as aspirational
    - Added LG representative to ReadMe
    - Need to convert google doc to markdown and add to Repository
...
- Florida Virtual Campus has created extensive in-house user documentation for Islandora 2
    - Did not discuss
    - TODO: add this FLVC info within the offical docs
    - Living document
...
- Updates/Highlights for Leadership Group meeting
    - [KEEP ON AGENDA]
    - Let them know we finished editing our Terms of Reference
